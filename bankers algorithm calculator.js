function reset(){
  ...
  document.getElementById('resourceP').value = '';
  document.getElementById('resourceQ').value = '';
  document.getElementById('resourceR').value = '';
...
function example(){
  ...
  document.getElementById('resourceP').value = 10;
  document.getElementById('resourceQ').value = 5;
  document.getElementById('resourceR').value = 7;
}


function find_avai(){
  var a = document.getElementById('resourceP').value;
  var b = document.getElementById('resourceQ').value;
  var c = document.getElementById('resourceR').value;
  var x = 0;
  var y = 0;
  var z = 0;
  for(var i=1; i<=5; i++){
